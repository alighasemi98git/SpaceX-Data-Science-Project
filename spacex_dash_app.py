...
def render_success_pie_chart(selected_site):
    if selected_site == 'ALL':
        # If all sites are selected, calculate the total success counts
        success_rate = spacex_df.groupby('Launch Site')['class'].sum()
        ...
        success_counts = site_df[site_df['class'] == 1]['class'].count()
        failure_counts = site_df[site_df['class'] == 0]['class'].count()
